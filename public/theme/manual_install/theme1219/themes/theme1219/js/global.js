...
function responsiveResize()
{
	...
	if (($(window).width()+scrollCompensate()) <= 987 && responsiveflag == false)
	{
		accordion('enable');
	...
	if (view == 'list')
	{
		...
		$('.product_list > li').each(function(index, element) {
			...
			html = '<div class="product-container"><div class="productInner"><div class="row">';
				...
				html += '</div>';	
				html += '<div class="right-block col-xs-8"><div class="right-block-content row">';
					html += '<div class="button-container col-xs-6">'+ $(element).find('.button-container').html() +'</div>';
					html += '<div class="functional-buttons clearfix col-xs-6">' + $(element).find('.functional-buttons').html() + '</div>';
				html += '</div>';
			html += '</div></div></div>';
		$(element).html(html);
		});		
