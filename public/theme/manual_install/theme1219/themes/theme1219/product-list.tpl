                ...
                <div class="product-container" itemscope itemtype="http://schema.org/Product"><div class="productInner">
                    <div class="left-block">
                        <div class="product-image-container">
                            ...
                            {if isset($product.new) && $product.new == 1}
                                <a class="new-box {if isset($product.on_sale) && $product.on_sale && isset($product.show_price) && $product.show_price && !$PS_CATALOG_MODE} with_sale{/if}" href="{$product.link|escape:'html':'UTF-8'}">
                    ...
                    <div class="right-block">
                        ...
                        <div class="functional-buttons clearfix">
                            ...
                            {/if}
                            <div class="moreBox {if (isset($product.customization_required) && $product.customization_required)}customize{/if}">
